...
public class Problem113 {
	...
	// 67. Napisati program koji uèitava troznamenkasti broj i ispisuje sumu znamenaka.
		...
		while(true) {
			...
			try {
				...
				if(a >= 100 && a <= 999) {
					...
					int d = (a/10)%10;
					int j = a%10;
					System.out.println(a + " - suma znamenki: " + (j + d + s));
				}else if(a >= -999 && a <= -100) {
					int s = a/100;
					int d = (a/10)%10;
					int j = a%10;
					System.out.println(a + " - suma znamenki: " + (j*-1 + d*-1 + s*-1));
				}else {
